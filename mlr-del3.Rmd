...
```{r}
# Data Preparation
# check missing values and inappropriate values
...
# replace negative mileage with NA
summary(bmw_data)
...
hist(log(bmw_data$price)) # left skewed

hist(bmw_data$price^0.25) # approximately normal
```
