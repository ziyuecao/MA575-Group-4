...
c(imputation_value, actual_value)
...
c(imputation_value2, actual_value2)
...
# Assess the trend in price of year's registered
summary(new_data3$year)
# Assess the trend of years' registered data
